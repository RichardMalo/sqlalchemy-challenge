...
Files used: app.py, climate_starter.ipynb, README.md, Folder Resources

Requirements for Excercise: Jupyter Notebook Database Connection (10 points) To receive all points, you must Use the SQLAlchemy create_engine() function to connect to your SQLite database (1 point)
